...
const  catalog = $('.catalog'),
    ...
    cellUpdateDOM = function (key) {
        ...
        const $cell = catalog.children('.cell').eq(key);
    ...
    saveState = function (cellsArray) {
        localStorage.setItem('catalog-' + getStorageKeySuffix(), JSON.stringify(cellsArray));
    },
    loadState = function () {
        let result = [];

        try {
            result = JSON.parse(localStorage.getItem('catalog-' + getStorageKeySuffix()));
        } catch (e) {
